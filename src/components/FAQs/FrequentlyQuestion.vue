  ...
  <div class="card basic-data-table">
        ...
        <div class="row gy-4 align-items-center">
          <div class="col-xl-7">
            ...
            <p class="mb-0 text-secondary-light max-w-634-px text-xl">
              ...
              Lorem Ipsum has been the industry's standard du text ever since the 1500s,
              when an unkn
            </p>
          </div>
    ...
    <div class="card-body bg-base responsive-padding-40-150">
      <div class="row gy-4">
        <div class="col-lg-4">
          <div
            class="active-text-tab nav flex-column nav-pills bg-base shadow py-0 px-24 radius-12 border"
            id="v-pills-tab"
            role="tablist"
          ...
          >
            ...
            <button
              class="nav-link text-secondary-light fw-semibold text-xl px-0 py-16"
          ...
          <div class="tab-content" id="v-pills-tabContent">
            ...
            >
              <div class="accordion" id="accordionExample">
                <div class="accordion-item" v-for="(item, index) in AbotUs" :key="index">
                  <h2 class="accordion-header">
                    <button
                      class="accordion-button text-primary-light text-xl"
                      type="button"
            ...
            >
              <div class="accordion" id="accordionExampleTwo">
                <div
                  ...
                  v-for="(item, index) in UiUxDesign"
                  :key="index"
                >
                  <h2 class="accordion-header">
                    <button
                      ...
                      type="button"
                      :data-bs-toggle="'collapse'"
                      :data-bs-target="'#c-' + (index + 1)"
                      :aria-expanded="index === 0 ? 'true' : 'false'"
                      :aria-controls="'c-' + (index + 1)"
                    >
                      {{ item.question }}
                    </button>
                  </h2>
                ...
                >
                  <h2 class="accordion-header">
                    <button
                      ...
                      type="button"
                      :data-bs-toggle="'collapse'"
                      :data-bs-target="'#c-' + (index + 7)"
                      :aria-expanded="index === 0 ? 'true' : 'false'"
                      :aria-controls="'c-' + (index + 7)"
                    >
                      {{ item.question }}
                    </button>
                  </h2>
            ...
            >
              <div class="accordion" id="accordionExampleFour">
                <div class="accordion-item" v-for="(item, index) in WowDash" :key="index">
                  <h2 class="accordion-header">
                    <button
                      class="accordion-button text-primary-light text-xl"
                      type="button"
                      :data-bs-toggle="'collapse'"
                      :data-bs-target="'#c-' + (index + 13)"
                      :aria-expanded="index === 0 ? 'true' : 'false'"
                      :aria-controls="'c-' + (index + 13)"
                    >
                      {{ item.question }}
                    </button>
                  </h2>
            ...
            >
              <div class="accordion" id="accordionExampleFIve">
                <div class="accordion-item" v-for="(item, index) in agency" :key="index">
                  <h2 class="accordion-header">
                    <button
                      class="accordion-button text-primary-light text-xl"
                      type="button"
                      :data-bs-toggle="'collapse'"
                      :data-bs-target="'#c-' + (index + 19)"
                      :aria-expanded="index === 0 ? 'true' : 'false'"
                      :aria-controls="'c-' + (index + 19)"
                    >
                      {{ item.question }}
                    </button>
                  </h2>
...
const componentName = "FrequentlyQuestion";

// Reactive data
const AbotUs = reactive([
  {
