                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="position-relative">
                                <input class="form-control radius-8 bg-base" ref="flatpickrDate" type="text"
                ...
                <div class="card-body">
                    <div class="row gy-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="#0" class="form-control form-control-lg"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="#0" class="form-control form-control-sm"
                                placeholder="info@gmail.com" />
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <textarea name="#0" class="form-control" rows="4" cols="50"
                                placeholder="Enter a description..."></textarea>
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label">Description</label>
                            <textarea name="#0" class="form-control" rows="4" cols="50"
                                placeholder="Enter a description..." readonly></textarea>
                        </div>
