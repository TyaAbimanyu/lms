  ...
  <div class="row gy-4">
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          <form ref="form1" class="row gy-3 needs-validation" novalidate @submit.prevent="handleSubmit($refs.form1)">
            <div class="col-md-6">
    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          <form ref="form2" class="row gy-3 needs-validation" novalidate @submit.prevent="handleSubmit($refs.form2)">
            <div class="col-md-6">
