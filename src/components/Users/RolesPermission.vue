<template>
  <div class="card basic-data-table">
    <div class="card-body">
      <div
        class="table-toolbar d-flex flex-wrap align-items-center justify-content-between gap-3"
        style="border-bottom: none; padding-bottom: 8px; padding-top: 1px"
      >
        <div class="d-flex flex-wrap align-items-center gap-3">
          <div class="d-flex align-items-center gap-2">
            <select
              class="form-select form-select-lr w-auto rounded-3 me-10"
            ...
            <tr v-for="user in paginatedUsers" :key="user.email">
              ...
              <td>
                <span
                  ...
                  class="px-20 py-4 rounded fw-medium text-sm"
                  >{{ user.status }}</span
                >
              </td>
              <td>
              ...
              <td>
                <select
                  ...
                  "
                >
                  <option v-for="group in permissionGroups" :key="group">
                    {{ group }}
                  </option>
                </select>
              </td>
              ...
              <td>
                <div class="d-flex align-items-center gap-2">
                  ...
                  <button
                    type="button"
                    class="btn rounded border text-info-500 border-info-500 radius px-4 py-6 bg-hover-info-500 text-hover-white flex-grow-1"
                  >
                    Edit
                  </button>
                  <button
                    type="button"
                    class="btn rounded border text-danger-500 border-danger-500 radius px-4 py-6 bg-hover-danger-500 text-hover-white flex-grow-1"
                  >
                    Delete
                  </button>
                </div>
