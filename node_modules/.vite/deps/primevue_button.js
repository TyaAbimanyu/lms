  ...
  if (args) {
    ...
    for (let i = 0; i < args.length; i++) {
      ...
      if (type === "string" || type === "number") {
        ...
        classes5 = _classes.length ? classes5.concat(_classes.filter((c) => !!c)) : classes5;
      }
    }
...
function getOuterWidth(element, margin) {
  if (element instanceof HTMLElement) {
    ...
    if (margin) {
      const style5 = getComputedStyle(element);
...
function minifyCSS(css5) {
  return css5 ? css5.replace(/\/\*(?:(?!\*\/)[\s\S])*\*\/|[\r\n\t]+/g, "").replace(/ {2,}/g, " ").replace(/ ([{:}]) /g, "$1").replace(/([;,]) /g, "$1").replace(/ !/g, "!").replace(/: /g, ":").trim() : css5;
}
...
var themeUtils_default = {
  ...
  getCommon({ name = "", theme = {}, params, set, defaults }) {
    ...
    let primitive_css, primitive_tokens, semantic_css, semantic_tokens, global_css, global_tokens, style5;
...
var BaseStyle = {
  ...
  load: function load(style5) {
    ...
    var computedStyle = transform(css(_templateObject || (_templateObject = _taggedTemplateLiteral(["", ""])), style5));
  ...
  loadStyle: function loadStyle() {
    ...
    return this.load(this.style, options, function() {
      ...
      return config_default.transformCSS(options.name || _this.name, "".concat(computedStyle).concat(css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["", ""])), style5)));
    });
  },
  ...
  computed: {
    ...
    defaultPT: function defaultPT() {
      ...
      return this._getPT((_this$$primevueConfig5 = this.$primevueConfig) === null || _this$$primevueConfig5 === void 0 ? void 0 : _this$$primevueConfig5.pt, void 0, function(value) {
        return _this4._getOptionValue(value, _this4.$name, _objectSpread3({}, _this4.$params)) || resolve(value, _objectSpread3({}, _this4.$params));
      });
    },
...
var BaseDirective = {
  ...
  _extend: function _extend(name) {
    ...
    var handleHook = function handleHook2(hook, el, binding, vnode, prevVnode) {
      ...
      var $options = isEmpty($prevInstance) ? _objectSpread5(_objectSpread5({}, options), options === null || options === void 0 ? void 0 : options.methods) : {};
...
var Ripple = BaseRipple.extend("ripple", {
  ...
  methods: {
    ...
    createRipple: function createRipple(el) {
      ...
      if (!ink) {
        ink = createElement("span", _defineProperty7(_defineProperty7({
          role: "presentation",
          "aria-hidden": true,
          "data-p-ink": true,
...
var script5 = {
  ...
  computed: {
    ...
    dataP: function dataP2() {
      return cn(_defineProperty9(_defineProperty9(_defineProperty9(_defineProperty9(_defineProperty9(_defineProperty9(_defineProperty9(_defineProperty9(_defineProperty9(_defineProperty9({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge), "loading", this.loading), "fluid", this.hasFluid), "rounded", this.rounded), "raised", this.raised), "outlined", this.outlined || this.variant === "outlined"), "text", this.text || this.variant === "text"), "link", this.link || this.variant === "link"), "vertical", (this.iconPos === "top" || this.iconPos === "bottom") && this.label));
    },
    dataIconP: function dataIconP() {
      return cn(_defineProperty9(_defineProperty9({}, this.iconPos, this.iconPos), this.size, this.size));
    },
    dataLabelP: function dataLabelP() {
      return cn(_defineProperty9(_defineProperty9({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge));
    }
  },
  components: {
    SpinnerIcon: script3,
